...
const accounts = [
  {
    ...
    almaMater: "Stanford University (2011-2015)",
  ...
  },
  {
    ...
    almaMater: "Stanford University (2013-2017)",
  ...
  },
  {
    ...
    almaMater: "Stanford University (2012-2016)",
  ...
  },
  {
    ...
    almaMater: "Stanford University (2014-2018)",
...
const DirectoryC = () => {
  return (
    <div className="p-10 container">
      <h1 className="text-center font-extrabold text-4xl font-serif">Directory</h1>
      <br />
    ...
    <button>Sort by Email</button> */}
      ...
      <div className="p-[1rem] grid grid-cols-4">
